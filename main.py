...
file_names = list_of_files(corpus_directory, ".txt")
tfidf_matrix = calculate_tf_idf(corpus_directory)

print("\nBienvenue dans le programme principal!")

while True:
    print("\nMenu Principal")
    print("1. Fonctionnalités de la partie I")
    print("2. Mode Chatbot")
    print("0. Quitter")
    choix_principal = input("\nChoisissez un mode (1-2) ou quittez (0): ")
    ...
    if choix_principal == '1':
        while True:
            ...
            print("\t\t12. Afficher le(s) noms(s) du (des) président(s) qui a (ont) parlé du climat et de l'écologie ")
            print("\t\t0. Revenir au menu principal")

            choix = input("Veuillez sélectionner une option (0-12) : ")
            ...
            if choix == "1":
                ...
                corpus_directory = "./cleaned"
                presidents_saying_nation = words_nation(corpus_directory, nom_president)
                result = words_nation(corpus_directory, nom_president)
                if presidents_saying_nation:
                    print("Le(s) président(s) qui a(ont) parlé de la « Nation » :", presidents_saying_nation)
                    print("Le(s) président(s) qui a(ont) le plus répété le mot « Nation » :",
                          result["Most Repeated President"])
                else:
                ...
                if result:
                    print("Le(s) président(s) qui a(ont) parlé du climat et/ou de l’écologie :",
                          list(result["Presidents"]))
                else:
                    print(
                        "Aucun président n'a parlé du climat et/ou de l’écologie ou les mots-clés n'ont pas été trouvés.")
            elif choix == '0':
                break
            else:
        ...
        most_relevant_doc_index = find_most_relevant_document(tfidf_matrix, question_tf_idf)
        most_relevant_doc_name = file_names[most_relevant_doc_index]
